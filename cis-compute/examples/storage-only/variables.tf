  ...
  type = object({
    ...
    instances = map(object({ # the instances to manage in this configuration.
      ...
      encryption = optional(object({ # encryption settings
        ...
        encrypt_in_transit_at_instance_creation = optional(bool,true) # whether to enable in-transit encryption for the data volume's paravirtualized attachment. Default is true. Applicable at instance creation time only.
        encrypt_in_transit_at_instance_update   = optional(bool,true) # whether to enable in-transit encryption for the data volume's paravirtualized attachment. Default is true. Applicable at instance update time only.
      }))
