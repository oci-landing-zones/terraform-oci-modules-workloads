...
```
For invoking the module remotely, set the module *source* attribute to the *compute-storage* module folder in this repository, as shown:
```
module "compute" {
  source = "github.com/oracle-quickstart/terraform-oci-secure-workloads/compute-storage"
  providers = {
    oci = oci
    oci.block_volumes_replication_region = oci.block_volumes_replication_region
  }
...
```
  source = "github.com/oracle-quickstart/terraform-oci-secure-workloads//compute-storage?ref=v0.1.0"
```
